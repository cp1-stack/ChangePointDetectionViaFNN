...
dataframe.to_csv("ChangePoints_data_train_beta05.csv", mode='a', header= False, index=False, sep=',')
# dataframe.to_csv("ChangePoints_data_test_beta05.csv", mode='w', header= False, index=False, sep=',')
