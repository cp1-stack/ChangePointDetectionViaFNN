...
# dataframe.to_csv("ChangePoints_data_train_beta1.csv", mode='a', header= False, index=False, sep=',')
dataframe.to_csv("ChangePoints_data_test_beta1.csv", mode='w', header= False, index=False, sep=',')
